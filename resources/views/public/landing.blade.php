                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-lg-3">
                        @auth
                            ...
                            @endphp
                            <a href="{{ $dashRoute }}" class="btn btn-primary rounded-pill px-4 py-2 fw-bold shadow-sm">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-outline-primary rounded-pill px-4 py-2 fw-bold">Masuk</a>
                        @endauth
                    </li>
                    @guest
