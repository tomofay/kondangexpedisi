        ...
        <div class="d-flex align-items-center justify-content-between w-100">
            <div>
                ...
                <div class="text-muted fw-bold" id="current-view-subtitle" style="font-size: 0.75rem; letter-spacing: 1px; text-transform: uppercase;">
                    Cabang: {{ $metrics['branch_name'] ?? 'Counter Utama' }}
                </div>
            </div>
        </div>
    </x-slot>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6 col-xl-3">
                    <div class="card-pro p-4 d-flex align-items-center gap-3">
                        ...
                        <div><div class="small text-muted fw-bold">SHIPMENTS TODAY</div><div class="h4 fw-bold mb-0" id="metric-shipments">{{ number_format($metrics['shipments_today'] ?? 0) }}</div></div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card-pro p-4 d-flex align-items-center gap-3">
                        <div class="p-3 bg-success-light rounded-4 text-success" style="background: #ECFDF5;"><i class="bi bi-wallet2 fs-4"></i></div>
                        <div><div class="small text-muted fw-bold">COLLECTED</div><div class="h4 fw-bold mb-0" id="metric-revenue">Rp{{ number_format($metrics['revenue_settlement_today'] ?? 0, 0, ',', '.') }}</div></div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card-pro p-4 d-flex align-items-center gap-3">
                        <div class="p-3 bg-warning-light rounded-4 text-warning" style="background: #FFFBEB;"><i class="bi bi-hourglass-split fs-4"></i></div>
                        <div><div class="small text-muted fw-bold">PENDING PAY</div><div class="h4 fw-bold mb-0" id="metric-approvals">{{ number_format($metrics['payments_pending'] ?? 0) }}</div></div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card-pro p-4 d-flex align-items-center gap-3">
                ...
                <div class="col-lg-12">
                    <div class="card-pro p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <a href="{{ isset($action['route']) ? route($action['route']) : '#' }}" 
                                   @if(isset($action['onclick'])) onclick="{{ $action['onclick'] }}" @endif
                                   class="quick-action-card p-4 rounded-4 d-block text-decoration-none text-dark bg-light text-center">
                                    <div class="icon-box p-3 rounded-4 mx-auto mb-3 d-inline-flex" style="background: {{ $action['bg'] }}; color: {{ $action['color'] }};">
        ...
        <div id="view-shipments" class="view-section">
            <div class="d-flex justify-content-between align-items-end mb-4">
                ...
                <div class="d-flex gap-3 align-items-center">
                    ...
                    <a href="{{ route('shipments.index') }}" class="btn btn-indigo rounded-pill px-4 fw-bold shadow-sm" style="background: #6366F1; color: white;"><i class="bi bi-plus-lg me-2"></i>Shipment Baru</a>
                </div>
            </div>
            <div class="card-pro p-4">
                <div class="table-responsive">
                        ...
                        case 'view-payments':
                            ...
                            tbody.innerHTML = response.data.data.map(item => `
                                <tr class="hover-row">
                                    ...
                                    <td class="text-end"><a href="{{ route('payments.index') }}" class="btn btn-sm btn-indigo rounded-pill px-3 fw-bold" style="font-size:0.75rem; background: #6366F1; color: white;">Proses</a></td>
                                </tr>`).join('') || '<tr><td colspan="5" class="text-center py-4">No data found.</td></tr>';
                            renderPagination(pagination, response.data, viewId);
                            break;
                    }
