                ...
                <div class="glass p-6 rounded-[2.5rem] border-white/40 flex items-center gap-5 transition-all relative overflow-hidden"
                    ...
                    <div class="flex-1 space-y-1 z-20 pointer-events-none">
                        ...
                        <div class="flex items-center gap-2 py-1">
                            <span class="text-[9px] font-black text-slate-400 uppercase truncate">{{ $shipment->branch->name }}</span>
                            <i class="bi bi-arrow-right text-[8px] text-blue-500"></i>
                            <span class="text-[9px] font-black text-blue-600 uppercase truncate">{{ $shipment->destinationBranch->name }}</span>
                        </div>
