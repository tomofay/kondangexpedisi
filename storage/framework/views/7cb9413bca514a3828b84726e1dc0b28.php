                ...
                <div class="auth-panel p-4 p-md-5">
                    ...
                    <form method="POST" action="<?php echo e(route('password.store')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" type="email" name="email" value="<?php echo e(old('email', $request->email)); ?>" class="form-control" autocomplete="username" required autofocus>
                        </div>
                    ...
                    <p class="small text-secondary mt-4 mb-0">
                        Kembali ke halaman
                        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none fw-semibold">login</a>
                    </p>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>