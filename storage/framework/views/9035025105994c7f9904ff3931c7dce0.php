            ...
            <div class="relative z-10 space-y-5">
                ...
                <div class="flex items-center gap-3 pt-2">
                    <div class="px-4 py-1.5 bg-white/10 backdrop-blur-xl rounded-xl border border-white/10">
                        <span class="text-[9px] font-black uppercase tracking-widest"><?php echo e($shipment->service_type); ?></span>
                    </div>
                    <div class="flex flex-col">
                        <p class="text-[9px] font-black text-blue-300 uppercase tracking-widest leading-none mb-1">Penerima</p>
                        <p class="text-xs font-bold text-white"><?php echo e($shipment->recipient_name); ?></p>
                    </div>
                </div>
            </div>
        </div>
