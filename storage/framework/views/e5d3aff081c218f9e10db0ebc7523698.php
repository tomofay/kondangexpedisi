...
<div class="space-y-8 animate-slide-up pb-40 px-1">
    ...
    <div class="flex items-center justify-between gap-2 px-1">
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('customer.dashboard')); ?>" class="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm text-blue-600 tap-scale border border-slate-100">
        ...
        <div class="px-4 py-2 bg-blue-50 rounded-2xl shrink-0">
            <span class="text-[9px] font-black text-blue-600 uppercase tracking-widest"><?php echo e($shipment->status->name); ?></span>
        </div>
    </div>
        ...
        <div class="relative z-10 space-y-8">
            ...
            <div class="flex items-center gap-4 py-8 border-y border-white/10">
                <div class="flex-1 space-y-1.5">
                    ...
                    <p class="text-xs font-black leading-tight"><?php echo e($shipment->branch->name); ?></p>
                </div>
                ...
                <div class="flex-1 text-right space-y-1.5">
                    ...
                    <p class="text-xs font-black leading-tight"><?php echo e(explode(',', $shipment->recipient_address)[0]); ?></p>
                </div>
            </div>
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-[9px] font-black text-blue-50 uppercase tracking-widest"><?php echo e($shipment->service_type); ?> Service</span>
                </div>
                <p class="text-[9px] font-black text-blue-100/60 uppercase tracking-widest italic"><?php echo e($shipment->created_at->format('d M Y')); ?></p>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-5">
                <div class="flex items-start gap-4">
                    ...
                    <div class="space-y-0.5">
                        ...
                        <p class="text-xs font-black text-slate-900"><?php echo e($shipment->recipient_name); ?></p>
                    </div>
                </div>
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-slate-400 shrink-0">
                    ...
                    <div class="space-y-0.5">
                        ...
                        <p class="text-xs font-black text-slate-900"><?php echo e($shipment->recipient_phone); ?></p>
                    </div>
                </div>
                <div class="flex items-start gap-4">
                    <div class="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-slate-400 shrink-0">
                    ...
                    <div class="space-y-0.5">
                        ...
                        <p class="text-xs font-bold text-slate-600 leading-relaxed"><?php echo e($shipment->recipient_address); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 gap-6">
        <div class="bg-white p-8 rounded-[2.5rem] border border-slate-50 shadow-xl shadow-slate-200/40 space-y-6">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $shipment->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="space-y-0.5">
                                <p class="text-xs font-black text-slate-900"><?php echo e($item->item_name); ?></p>
                                <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest"><?php echo e($item->weight_kg); ?> Kg / Unit</p>
                            </div>
                        </div>
                        <div class="text-right">
                            <p class="text-xs font-black text-blue-600"><?php echo e($item->quantity); ?> Pcs</p>
                        </div>
                    </div>
            ...
            <div class="pt-4 border-t border-slate-100 flex justify-between items-center">
                ...
                <p class="text-sm font-black text-slate-900"><?php echo e($shipment->total_weight_kg); ?> Kg</p>
            </div>
        </div>
    </div>
    ...
    <div>
        <?php if($shipment->payment_status === 'paid'): ?>
            <div class="bg-emerald-500 rounded-[2.5rem] p-8 text-white space-y-4 shadow-xl relative overflow-hidden">
                ...
                <div class="pt-4 border-t border-white/10 relative z-10">
                    <a href="<?php echo e(route('shipments.label', $shipment)); ?>" target="_blank" 
        ...
        <?php elseif($shipment->payment_status === 'pending' || $shipment->payment_status === 'unpaid'): ?>
            <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 text-slate-900 space-y-8 shadow-xl relative overflow-hidden">
                <div class="flex justify-between items-center relative z-10">
                    <div class="space-y-1">
                        ...
                        <h4 class="text-3xl font-black italic tracking-tighter text-blue-600">Rp <?php echo e(number_format($shipment->total_amount, 0, ',', '.')); ?></h4>
                    </div>
        ...
        <?php elseif(in_array($shipment->payment_status, ['failed', 'expire', 'cancel'])): ?>
    ...
    <div class="bg-white p-8 rounded-[3rem] border border-slate-50 shadow-xl shadow-slate-200/40 space-y-10">
        ...
        <div class="relative space-y-12">
            ...
            <div class="relative flex gap-5">
                ...
                <div class="flex-1 space-y-1.5">
                    <div class="flex justify-between items-start">
                        ...
                        <span class="text-[8px] font-black text-slate-400 bg-slate-50 px-3 py-1 rounded-lg uppercase tracking-widest"><?php echo e($shipment->created_at->format('H:i • d M')); ?></span>
                    </div>
            ...
            <!-- Dynamic Trackings -->
            <?php $__currentLoopData = $shipment->trackings->sortBy('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tracking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $isLatest = $loop->last; ?>
                <div class="relative flex gap-5">
                    <div class="w-7 h-7 rounded-xl <?php if($isLatest): ?> bg-blue-600 shadow-xl shadow-blue-200 <?php else: ?> bg-white border border-slate-200 <?php endif; ?> z-10 shrink-0 flex items-center justify-center transition-all">
                        <?php if($isLatest): ?>
                    ...
                    <div class="flex-1 space-y-2.5 <?php if(!$isLatest): ?> pb-10 border-b border-slate-50 <?php endif; ?>">
                        <div class="flex justify-between items-start">
                            <h4 class="font-black text-xs <?php if($isLatest): ?> text-blue-600 <?php else: ?> text-slate-700 <?php endif; ?> uppercase tracking-tight"><?php echo e($tracking->status->name); ?></h4>
                            <span class="text-[8px] font-black text-slate-400 bg-slate-50 px-3 py-1 rounded-lg uppercase tracking-widest"><?php echo e($tracking->created_at->format('H:i • d M')); ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-[11px] text-slate-600 font-black leading-tight"><?php echo e($tracking->location); ?></p>
                        </div>
...
<?php if(in_array($shipment->payment_status, ['pending', 'unpaid', 'failed', 'expire', 'cancel'])): ?>
...
<script type="text/javascript">
    ...
    if (payButton) {
        payButton.onclick = function() {
            ...
            fetch(`/payments/<?php echo e($shipment->id); ?>/midtrans/snap-token`, {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('mobile.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/mobile/customer/tracking.blade.php ENDPATH**/ ?>