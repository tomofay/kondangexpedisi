    ...
    <div class="auth-container">
        ...
        <div class="auth-form-side animate__animated animate__fadeInRight">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group-clean">
                        ...
                        <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Contoh: Budi Santoso" required autofocus autocomplete="name">
                    </div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group-clean">
                        ...
                        <input id="phone" type="text" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Contoh: 08123456789" required autocomplete="tel">
                    </div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group-clean">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="nama@perusahaan.com" required autocomplete="username">
                    </div>
                </div>
            ...
            <div class="mt-4 pt-3 border-top text-center">
                ...
                <a href="<?php echo e(route('login')); ?>" class="text-primary fw-bold text-decoration-none">Masuk di sini</a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/auth/register.blade.php ENDPATH**/ ?>