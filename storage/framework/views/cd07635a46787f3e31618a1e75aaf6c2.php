...
<?php $component->withAttributes([]); ?>
        ...
        <div class="d-flex align-items-center justify-content-between w-100">
            <div>
                ...
                <div class="text-muted fw-bold" id="current-view-subtitle" style="font-size: 0.75rem; letter-spacing: 1px; text-transform: uppercase;">
                    Ringkasan Operasional Cabang: <?php echo e($metrics['branch_name'] ?? 'Pusat'); ?>
    ...
    <script>
        ...
        const userBranchId = <?php echo e(auth()->user()->branch_id ?? 'null'); ?>;
                        ...
                        case 'view-approvals':
                            ...
                            tbody.innerHTML = response.data.data.data.map(item => `
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ${item.status === 'pending' && !['approve_new_rate_card', 'approve_rate_card'].includes(item.task_type) && item.created_by !== <?php echo e(auth()->id()); ?> ? `
...
<?php endif; ?>
<?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/dashboard/manager.blade.php ENDPATH**/ ?>