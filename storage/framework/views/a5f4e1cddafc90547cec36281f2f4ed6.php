...
<div class="space-y-8 animate-slide-up">
    <!-- Welcome -->
    <div class="space-y-1">
        <h2 class="text-2xl font-extrabold tracking-tight">Halo, <?php echo e(explode(' ', $customer->name)[0]); ?>!</h2>
        ...
        <div class="relative z-10 space-y-6">
            <div class="flex justify-between items-start">
                <div class="space-y-1">
                    ...
                    <h3 class="text-5xl font-black"><?php echo e($stats['shipments_total']); ?></h3>
                </div>
            ...
            <div class="flex gap-3">
                <div class="flex-1 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                    ...
                    <p class="text-xl font-extrabold"><?php echo e($stats['pending_shipments']); ?></p>
                </div>
                <div class="flex-1 bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                    <p class="text-[10px] font-bold text-primary-100 uppercase mb-1">Berhasil</p>
                    <p class="text-xl font-extrabold"><?php echo e($stats['payments_total']); ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <a href="<?php echo e(route('customer.shipments.track', $shipment)); ?>" 
                   class="flex items-center gap-4 bg-white dark:bg-slate-900 p-4 rounded-3xl premium-shadow border border-slate-100 dark:border-slate-800 active:scale-[0.98] transition-all">
                    ...
                    <div class="flex-1 min-w-0">
                        <h4 class="font-bold text-sm truncate uppercase"><?php echo e($shipment->tracking_number); ?></h4>
                        <p class="text-xs text-slate-500 font-medium"><?php echo e($shipment->service_type); ?> • <?php echo e($shipment->created_at->format('d M Y')); ?></p>
                    </div>
