...
<div class="space-y-12 animate-slide-up pb-10">
    ...
    <div class="relative overflow-hidden bg-blue-600 p-10 rounded-[3rem] text-white shadow-2xl">
        ...
        <div class="relative z-10 space-y-4">
            <div class="space-y-1">
                ...
                <h2 class="text-3xl font-black tracking-tight leading-none"><?php echo e(explode(' ', $customer->name)[0]); ?>!</h2>
            </div>
        </div>
    </div>
    ...
    <!-- Quick Track Search -->
    <div class="px-1">
        <form action="<?php echo e(route('customer.shipments.search')); ?>" method="GET" class="relative group">
            ...
            <div class="relative z-10 space-y-10">
                <div class="flex justify-between items-center">
                    <div class="space-y-1">
                        ...
                        <h3 class="text-5xl font-black text-slate-900 tracking-tighter italic leading-none"><?php echo e($stats['shipments_total']); ?></h3>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100/50 space-y-2">
                        ...
                        <p class="text-2xl font-black text-slate-900 leading-none"><?php echo e($stats['pending_shipments']); ?></p>
                    </div>
                    <div class="p-6 bg-slate-50/50 rounded-[2rem] border border-slate-100/50 space-y-2">
                        ...
                        <p class="text-2xl font-black text-slate-900 leading-none"><?php echo e($stats['payments_total']); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="space-y-6 px-1">
        ...
        <div class="grid grid-cols-4 gap-4">
            ...
            <a href="<?php echo e(route('customer.shipments.create')); ?>" class="flex flex-col items-center gap-4 tap-scale group">
                <div class="w-16 h-16 bg-white rounded-3xl flex items-center justify-center shadow-xl shadow-slate-200/50 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all border border-slate-50">
                    <i class="bi bi-<?php echo e($service['icon']); ?> fs-3"></i>
                </div>
                <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest text-center leading-tight"><?php echo e($service['label']); ?></span>
            </a>
    ...
    <div class="space-y-6 px-1">
        <div class="flex justify-between items-end px-4">
            ...
            <a href="<?php echo e(route('customer.shipments.index')); ?>" class="text-blue-600 text-[10px] font-black uppercase tracking-widest bg-blue-50 px-4 py-2 rounded-xl tap-scale transition-all hover:bg-blue-600 hover:text-white">Lihat Semua</a>
        </div>

        <div class="space-y-5">
            <?php $__empty_1 = true; $__currentLoopData = $stats['recent_shipments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                    $statusColors = [
                   ...
                   class="flex items-center gap-5 bg-white p-6 rounded-[2.5rem] shadow-xl shadow-slate-200/30 border border-slate-50 tap-scale group">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-2 mt-1.5">
                            <span class="text-[8px] font-black px-2.5 py-1 rounded-lg <?php echo e($badgeClass); ?> uppercase tracking-widest"><?php echo e($shipment->status->name); ?></span>
                            <span class="text-[8px] font-bold text-slate-300 uppercase italic"><?php echo e($shipment->created_at->format('d M')); ?></span>
                        </div>
                    </div>
                    <div class="shrink-0">
...
<?php echo $__env->make('mobile.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/mobile/customer/dashboard.blade.php ENDPATH**/ ?>