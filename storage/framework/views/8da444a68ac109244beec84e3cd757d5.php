    ...
    <div class="auth-container">
        <div class="otp-card animate__animated animate__fadeInUp">
            ...
            <div class="mt-4 pt-3 border-top">
                <p class="small text-muted mb-0">Tidak menerima kode? <a href="<?php echo e(route('register')); ?>" class="text-primary fw-bold text-decoration-none">Daftar Ulang</a></p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>