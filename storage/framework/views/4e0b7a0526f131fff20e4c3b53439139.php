...
<div class="space-y-8 animate-slide-up pb-32">
    ...
    <div class="flex items-center justify-between px-1">
        <div class="space-y-1">
            ...
            <p class="text-slate-500 font-bold text-[10px] uppercase tracking-widest flex items-center gap-2">
                ...
                <?php echo e(date('d M Y')); ?> • <?php echo e($stats['pending']); ?> Paket Aktif
            </p>
        </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="relative group">
            ...
            <div class="relative glass p-6 rounded-[2rem] space-y-3 border-white/40">
                ...
                <p class="text-3xl font-black italic tracking-tighter text-blue-600"><?php echo e($stats['pending']); ?></p>
            </div>
        </div>
        <div class="relative group">
            ...
            <div class="relative glass p-6 rounded-[2rem] space-y-3 border-white/40">
                ...
                <p class="text-3xl font-black italic tracking-tighter text-emerald-600"><?php echo e($stats['completed']); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between px-1">
            ...
            <a href="<?php echo e(route('courier.shipments.index')); ?>" class="text-[10px] font-black uppercase tracking-widest text-blue-600">Lihat Semua</a>
        </div>
                ...
                <div class="glass p-8 rounded-[2.5rem] premium-shadow border-white/40 space-y-8 relative overflow-hidden tap-scale transition-all">
                    ...
                    <div class="flex justify-between items-start relative z-10">
                        <div class="space-y-1">
                            ...
                            <h3 class="text-2xl font-black italic tracking-tighter text-blue-600 uppercase"><?php echo e($task->tracking_number); ?></h3>
                        </div>
                        <div class="px-4 py-2 bg-blue-600 text-white rounded-2xl shadow-lg shadow-blue-200 dark:shadow-none">
                            <span class="text-[10px] font-black uppercase tracking-widest"><?php echo e($task->status->name); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 border-t border-slate-100 dark:border-slate-800/50 pt-6">
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <div class="flex-1 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800">
                                ...
                                <p class="text-[10px] font-black text-slate-700 dark:text-slate-200 truncate"><?php echo e($task->branch->name); ?></p>
                            </div>
                            ...
                            <div class="flex-1 p-3 bg-blue-50/50 dark:bg-blue-900/20 rounded-2xl border border-blue-100/50 dark:border-blue-900/30">
                                ...
                                <p class="text-[10px] font-black text-blue-700 dark:text-blue-200 truncate"><?php echo e($task->destinationBranch->name); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="space-y-1 flex-1">
                                ...
                                <p class="text-sm font-black leading-tight text-slate-800 dark:text-slate-100"><?php echo e($task->recipient_name); ?></p>
                                <p class="text-[11px] font-bold text-slate-500 leading-relaxed truncate"><?php echo e($task->recipient_address); ?></p>
                            </div>
                        </div>
                    </div>

                    <div class="flex gap-4">
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $task->recipient_phone)); ?>" class="flex-1 glass h-14 rounded-2xl flex items-center justify-center gap-2 text-blue-600 font-black text-[11px] uppercase tracking-widest shadow-sm border-blue-50">
                            <i class="bi bi-whatsapp fs-5"></i> Hubungi
                        </a>
                        <a href="<?php echo e(route('courier.shipments.edit', $task)); ?>" class="flex-1 bg-blue-600 text-white h-14 rounded-2xl flex items-center justify-center gap-2 font-black text-[11px] uppercase tracking-widest shadow-xl shadow-blue-200 dark:shadow-none">
...
<?php echo $__env->make('mobile.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/mobile/courier/tasks.blade.php ENDPATH**/ ?>