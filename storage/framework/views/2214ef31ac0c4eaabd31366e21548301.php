...
<body>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-clean-group"><i class="bi bi-geo-fill"></i>
                                                <select name="origin_branch_id" required>
                                                    ...
                                                    <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($b->id); ?>"><?php echo e($b->city); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-clean-group"><i class="bi bi-lightning-charge-fill"></i>
                                                <select name="service_type">
                                                    <?php $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($s); ?>"><?php echo e(strtoupper($s)); ?></option> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
    ...
    <div class="stats-strip">
        <div class="container text-center">
            <div class="row g-4">
                <div class="col-md-4">
                    <h2 class="fw-bold mb-0"><?php echo e(number_format($statistics->where('title','total_shipments')->first()?->content ?? 2500)); ?>+</h2>
                ...
                <div class="col-md-4">
                    <h2 class="fw-bold mb-0"><?php echo e($branches->count()); ?>+</h2>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #0061FF 0%, #4F46E5 100%); margin: 80px 0;">
        <div class="container text-center py-4">
            ...
            <div class="d-flex gap-3 justify-content-center flex-wrap">
                <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-light rounded-pill px-5 py-3 fw-bold shadow-sm" style="font-size:1rem; color:#0061FF;"><i class="bi bi-person-plus-fill me-2"></i>Daftar Gratis</a>
                <?php endif; ?>
    ...
    <footer class="footer-main" id="kontak">
        <div class="container">
            ...
            <div class="d-flex flex-wrap justify-content-between gap-3 text-white-50 small">
                <span>© <?php echo e(now()->year); ?> Kondang Ekspedisi. Hak Cipta Dilindungi.</span>
...
<?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/public/landing.blade.php ENDPATH**/ ?>