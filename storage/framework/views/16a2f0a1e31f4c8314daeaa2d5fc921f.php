    ...
    <div class="auth-container">
        ...
        <div class="auth-form-side animate__animated animate__fadeInRight">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group-clean">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="nama@perusahaan.com" required autofocus autocomplete="username">
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a class="text-decoration-none small fw-bold text-primary" href="<?php echo e(route('password.request')); ?>">Lupa Sandi?</a>
                    <?php endif; ?>
                </div>
            ...
            <div class="mt-5 pt-4 border-top text-center">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-primary fw-bold text-decoration-none">Daftar Gratis Sekarang</a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\toram\OneDrive\Desktop\projek\ekspedisi-online\resources\views/auth/login.blade.php ENDPATH**/ ?>